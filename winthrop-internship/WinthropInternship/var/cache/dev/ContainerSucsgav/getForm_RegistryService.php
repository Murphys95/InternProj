...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\FLFormType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\FLFormType']) ? $this->services['AppBundle\Form\FLFormType'] : $this->services['AppBundle\Form\FLFormType'] = new \AppBundle\Form\FLFormType()) && false ?: '_'};
}, 'AppBundle\\Form\\HRFormType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\HRFormType']) ? $this->services['AppBundle\Form\HRFormType'] : $this->services['AppBundle\Form\HRFormType'] = new \AppBundle\Form\HRFormType()) && false ?: '_'};
